...
<div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasChat"
    aria-labelledby="offcanvasWithChat">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasWithChat">
            <i class="bi bi-chat-quote"></i>
            Chat Musrenbang
            (<span id="canvas_notif_total">10</span>)
        </h5>
    </div>
...
<?php /**PATH C:\xampp\htdocs\desacuss_new\resources\views/user/canvas.blade.php ENDPATH**/ ?>